...
export class Compass {
    constructor() {
        ...
        this.canvasSizeMultiplier = 'auto';
    ...
    resizeCanvas() {
        ...
        let multiplier = this.canvasSizeMultiplier;
    ...
    setMode(mode) {
        this.mode = 'crosshair'; // Only crosshair mode supported
    }
    ...
    update(map, samples, amplitudes, playingIds = [], flightBearing = 0, pitch = 0, info = null) {
        ...
        // Only crosshair mode is supported
